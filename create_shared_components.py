...
why_choose_us_code = """import React from "react";
...
with open('src/components/WhyChooseUs.jsx', 'w', encoding='utf-8') as f:
    f.write(why_choose_us_code)

enquire_now_cta_code = """import React from "react";
...
"""
with open('src/components/EnquireNowCTA.jsx', 'w', encoding='utf-8') as f:
    f.write(enquire_now_cta_code)
