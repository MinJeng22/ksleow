      ...
      <div id="why-ksl" className="product-app-section product-app-section-warm" style={{ padding: "4rem 0", scrollMarginTop: 24 }}>
        ...
        <div className="content-wrap" style={{ textAlign: "center" }}>
          ...
          <p style={{
            ...
            Proudly Recognized as the Top AutoCount Dealer in Pahang State for 7 Consecutive Years — Empowering Your Business with 40+ Years of Expertise, Prompt On-Site Support & Dedicated Training
          </p>
