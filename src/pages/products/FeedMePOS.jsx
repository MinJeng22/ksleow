...
const FEEDME_OVERVIEW_TABS = [
  ...
  },
  {
    ...
    featureImage: "https://pass-cors.feedme-farm.workers.dev?target=https%3A%2F%2Fdrive.google.com%2Fuc%3Fexport%3Ddownload%26id%3D1lO5Dk5TPxVQ-Yfju88T9mqd08cyY6fPp",
    featureAlt: "FeedMe Connect product overview",
  ...
  },
  {
    ...
    featureImage: "https://pass-cors.feedme-farm.workers.dev?target=https%3A%2F%2Fdrive.google.com%2Fuc%3Fexport%3Ddownload%26id%3D1AdxGx8-rdTya0f-RU8738HviiyhYIBpF",
    featureAlt: "FeedMe Inventory product overview",
  ...
  },
  {
    ...
    featureImage: "https://pass-cors.feedme-farm.workers.dev?target=https%3A%2F%2Fdrive.google.com%2Fuc%3Fexport%3Ddownload%26id%3D1QFdkj0N0WvOGM6-kjK1dkfculUEfpLTv",
    featureAlt: "FeedMe Report product overview",
  ...
  },
  {
    ...
    featureImage: "https://pass-cors.feedme-farm.workers.dev?target=https%3A%2F%2Fdrive.google.com%2Fuc%3Fexport%3Ddownload%26id%3D13DzB8bAhUNKViOHDKdpqRgg9V4R3Xf9S",
    featureAlt: "FeedMe Mini Program product overview",
  ...
  },
  {
    ...
    featureImage: "https://pass-cors.feedme-farm.workers.dev?target=https%3A%2F%2Fdrive.google.com%2Fuc%3Fexport%3Ddownload%26id%3D1xzVhskV742cZm97Ny3u6N4OQIewIOKOf",
    featureAlt: "FeedMe HRM product overview",
  ...
  },
  {
    ...
    featureImage: "https://pass-cors.feedme-farm.workers.dev?target=https%3A%2F%2Fdrive.google.com%2Fuc%3Fexport%3Ddownload%26id%3D1ADSKfbtsSM7fwmzrm8JEQojl2Zx2bZL4",
    featureAlt: "FeedMe REMY product overview",
  ...
  return (
    <div id="page-feedme-pos" className="pinned-hero-page product-app-page" style={{ minHeight: "100vh" }}>
      <style>{`
        ...
        #page-feedme-pos .feedme-official-overview-section {
          background: #fbe5cb;
          border-bottom: 3px solid var(--feedme-orange);
          position: relative;
          z-index: 1;
        }
        #page-feedme-pos .feedme-official-overview {
          margin: 0 auto;
          max-width: 1280px;
          padding: 4.9rem 1rem 3.65rem;
          position: relative;
          text-align: center;
          z-index: 1;
        }
        #page-feedme-pos .feedme-overview-tabs {
          align-items: flex-start;
          display: grid;
          gap: clamp(1.35rem, 5.6vw, 4.4rem);
          grid-template-columns: repeat(7, minmax(74px, auto));
          justify-content: center;
          margin: 0 auto;
        }
        ...
        #page-feedme-pos .feedme-overview-tab.is-active {
          color: var(--feedme-orange);
        }
        #page-feedme-pos .feedme-overview-tab.is-active img {
          height: 70px;
          margin-top: -10px;
        }
        #page-feedme-pos .feedme-overview-tab.is-active::after {
          background: var(--feedme-orange);
          bottom: -0.6rem;
          content: "";
          height: 2px;
        ...
        #page-feedme-pos .feedme-overview-button:hover {
          background: #e66518;
          transform: translateY(-1px);
        }
        #page-feedme-pos .feedme-overview-button:focus-visible {
          outline: 3px solid rgba(255, 120, 35, 0.34);
          outline-offset: 3px;
        }
