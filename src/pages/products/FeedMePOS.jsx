...
export default function FeedMePOSPage() {
  ...
  return (
    <div className="pinned-hero-page product-app-page" style={{ minHeight: "100vh" }}>
      ...
      {/* ── Key Features ── */}
      <div id="features" className="product-app-section product-app-section-paper product-app-section-to-mist product-app-section-clean" style={{ ...S.section, scrollMarginTop: 24 }}>
        <div className="content-wrap">
